      ...
      <div class="card-body px-0 pt-0 pb-2">
         <div class="table-responsive p-0">
            <table class="table align-items-center mb-0">
               <thead>
                  <tr>
                     <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ID <span class="ms-4">Name</span></th>
                     <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-1">description</th>
                  ...
                  <tr v-for="(item, index) in g$list" :key="index">
                     ...
                     <td class="align-middle">
                        <div class="ms-auto text-center">
                           <a href="javascript:;" class="text-secondary font-weight-bold text-xs ms-4" data-toggle="tooltip" data-original-title="Edit user"><i class="ni ni-settings-gear-65 text-success text-lg opacity-10"></i></a>
                           <button class="btn btn-brand text-danger text-gradient ms-lg-2" href="javascript:;" @click.prevent="deleteTodo(item.id)"><i class="far fa-trash-alt me-2" aria-hidden="true"></i>Delete</button>
                        </div>
                     </td>
                  </tr>
               </tbody>
